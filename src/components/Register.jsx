    ...
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-50 to-purple-50 items-center justify-center p-12">
        <div className="relative">
          <img src="/src/assets/images/spaceship.png" alt="Space illustration" className="w-96 h-96 object-contain" />
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 outline-none text-base bg-white"
              >
